...
# Supply a software name to search on
Write-Host "This script will loop through the registry looking for both 32bit and 64bit versions." -ForegroundColor Green
$SoftwareName = Read-Host -Prompt "Supply Software Name"

$SoftwareRequest = "<h2>Searched for: <h4>$SoftwareName</h4></h2>"
...
# Show Installed    
$Installed = $mutli | Where {$_.ComputerName -ne $null -and $_.DisplayName -ne $null -and $_.DisplayName -like “*$($SoftwareName)*” -and $_.DisplayVersion -ne $Null } | Sort-Object -Property ComputerName,DisplayName 
# -Unique
...
$InstalledButton = "<h2>Software Versions Installed On:<pd>$($TotalCountInstalledHTML)</pd></h2><button type='button' class='collapsible'><h3>+</h3></button> <div class='content'><p>$InstalledHTML</p></div>"
...
$ListCompareNoResponceButton = "<h2>No Repsonse:<pd>$($TotalCountListNoResponceHTML)</pd> </h2><button type='button' class='collapsible'><h3>+</h3></button> <div class='content'><p>$ListCompareNoResponceHTML</p></div>"
...
$ListNotInstalledButton = "<h2>Software Not Installed On:<pd>$($TotalCountListNotInstalledHTML)</pd></h2><button type='button' class='collapsible'><h3>+</h3></button> <div class='content'><p>$ListNotInstalledHTML</p></div>"
