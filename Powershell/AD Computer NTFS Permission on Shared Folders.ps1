...
$Output = Get-LHSsharedFolderNTFSPermission -ComputerName $ComputerSelect.Name -ErrorAction SilentlyContinue

# Display Output in Grid-View
$Output | Out-GridView -Title "NTFS Shared Folder Permissions"
