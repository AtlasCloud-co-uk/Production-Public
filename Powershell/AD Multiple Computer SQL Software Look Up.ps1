...
# Page Title
$PageTitle = "<h1>SQL Software List Report</h1>"
...
$SoftwareName = Import-Csv -Path "C:\Powershell Scripts\CSV\SQLSoftware.csv"
...
$Report | Out-File -FilePath c:\temp\SQL-List-Report.html
Invoke-Expression c:\temp\SQL-List-Report.html
